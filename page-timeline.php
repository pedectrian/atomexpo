...
<?php 
    ...
    // WPML
    if (function_exists('icl_translate')) { $wpml_lang = $sitepress->get_current_language(); } else { $wpml_lang = ""; }
                                                ...
                                                <?php 
                                                    if (empty($cmb_hide_feat_img)) {
                                                        if ( ($cmb_feature == "media") && (!empty($cmb_media_link)) ) {
                                                            ...
                                                            printf('<a href="%s" class="mosaic-overlay fancybox fancybox.iframe"></a>', esc_url($cmb_media_link));
