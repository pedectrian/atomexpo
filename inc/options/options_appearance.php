							...
							<tr valign='top'>
								<td>
									<img src="<?php echo get_template_directory_uri() ?>/img/skin_btn_default.png" alt="" 
										...
										data-body_skin_class					="default"

										data-color_feat_text_1					="#ffc000"
										data-color_feat_text_2					="#4170a9"
										data-color_plate						="#ffffff"
										data-color_body							="#ffffff"
										data-color_general_text					="#666666"
										data-color_headings						="#1d2028"
										data-color_white_text					="#ffffff"
										data-color_meta							="#9c9fa4"
										
										data-color_header_nav					="#1d2028"
										data-color_preheader					="#313540"
										data-color_menu_nav						="#ffc000"
										data-color_premenu_nav					="#bec0c7"
										data-color_third_nav					="#313540"
										data-color_third_prenav					="#242931"
										data-color_feature_1					="#ffc000"
										data-color_feature_2					="#4170a9"
										data-color_feature_3					="#2f353f"
										...
										data-color_footer_block					="#313540"
										data-color_footer_base					="#1d2028"
										data-color_footer_headings				="#ffffff"
										data-color_footer_text					="#bdc0c6"
										data-color_footer_featuretext			="#ffc000"
									...
									<img src="<?php echo get_template_directory_uri() ?>/img/skin_btn_new.png" alt="" 
									
										data-body_skin_class					="new"

										data-color_feat_text_1					="#f0680e"
										data-color_feat_text_2					="#da2649"
										data-color_plate						="#fcfbf8"
										data-color_body							="#ffffff"
										data-color_general_text					="#483f38"
										data-color_headings						="#0e0802"
										data-color_white_text					="#ffffff"
										data-color_meta							="#978c80"
										
										data-color_header_nav					="#28211d"
										data-color_preheader					="#403731"
										data-color_menu_nav						="#f0680e"
										data-color_premenu_nav					="#bec0c7"
										data-color_third_nav					="#403731"
										data-color_third_prenav					="#28211d"
										data-color_feature_1					="#e8792f"
										data-color_feature_2					="#da2649"
										data-color_feature_3					="#2f353f"
										
										data-color_feature_block				="#f4f2e3"
										data-color_feature_block_2				="#e3dfc5"
										data-color_light_button					="#E8E8E8"
										data-color_white_button					="#ffffff"
										data-color_dark_button					="#403731"
										data-color_form_fields_bg				="#efeee7"
										data-color_form_fields_text				="#9b8c7b"
										data-color_price_table					="#f6f5ef"
										data-color_elements						="#f6f5ef"
										data-color_lines						="#eae4dd"
										
										data-color_footer_block					="#403731"
										data-color_footer_base					="#28211d"
										data-color_footer_headings				="#ffffff"
										data-color_footer_text					="#c6c2ba"
										data-color_footer_featuretext			="#e8792f"
										data-color_footer_button				="#da2649"
										data-color_footer_form_fields_bg		="#594e46"
										data-color_footer_form_fields_text		="#ffffff"
										data-color_footer_form_fields_focus		="#82776d"
										data-color_footlines					="#5d524b"
										data-color_responsive_menu				="#58483c"
