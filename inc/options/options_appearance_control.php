	...
	function default_canon_options_appearance () {
		...
		if (get_option('canon_options_appearance') == FALSE) {		//trying to get options 'canon_options_appearance' which doesn't yet exist results in FALSE
		 	$options = array (
			 		...
			 		'color_feat_text_1'					=> '#ffc000',
			 		'color_feat_text_2'					=> '#4170a9',
			 		'color_plate'						=> '#fff',
			 		'color_body'						=> '#ffffff',
			 		'color_general_text'				=> '#666666',
			 		'color_headings'					=> '#1d2028',
			 		'color_white_text'					=> '#fff',
			 		'color_meta'						=> '#9c9fa4',

			 		'color_menu_nav'					=> '#ffc000',
			 		'color_premenu_nav'					=> '#bec0c7',
			 		'color_header_nav'					=> '#1d2028',
			 		'color_preheader'					=> '#313540',
			 		'color_third_nav'					=> '#313540',
			 		'color_third_prenav'				=> '#242931',
			 		'color_feature_1'					=> '#ffc000',
			 		'color_feature_2'					=> '#4170a9',
			 		'color_feature_3'					=> '#2f353f',
			 		...
			 		'color_footer_block'				=> '#313540',
			 		'color_footer_base'					=> '#1d2028',
			 		'color_footer_headings'				=> '#ffffff',
			 		'color_footer_text'					=> '#bdc0c6',
			 		'color_footer_featuretext'			=> '#ffc000',
