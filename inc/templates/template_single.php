...
?>
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <!-- FEATURED IMAGE -->
        <?php 
            if ( ($posts_in_slider > 0) && ( $cmb_single_style == "full" || $cmb_single_style == "boxed") ) {
            ?>
                ...
                <div class="main wrapper clearfix">
                    ...
                    <div class="main-content">
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class("clearfix"); ?>>
                            ...
                            <!-- META -->
                            <aside class="left-aside right last fourth">
                                <ul class="meta">
                                    <?php get_sidebar(); ?>
                                </ul>	
                            </aside> 
                            ...
                            <div class="three-fourths left">
                                ...
                                <!-- FEATURED IMAGE -->
                                <?php 
                                    if ( ($posts_in_slider > 0) && ( $cmb_single_style == "compact") ) {
                                    ?>
                                        <div class="compact">
